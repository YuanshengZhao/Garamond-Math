...
\newfontface\SymbolFont{Garamond-Math.otf}[Path=../, StylisticSet=1]
%\newfontface\SymbolFont{FiraSans-Regular.otf}
%\newfontface\SymbolFont{xits-math.otf}
\newfontface\BMPFallbackFont{unifont-10.0.07.ttf}[Path=../]
\newfontface\SMPFallbackFont{unifont_upper-10.0.07.ttf}[Path=../]
