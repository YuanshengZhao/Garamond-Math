...
\setmathfont{Garamond-Math.otf}[Path=../Release/,StylisticSet={1,2,6,7,10}]
...
\end{split}\]
It is known to all that $\sqrt 2$ is irrational $\frac{\partial y}{\partial x}h\hbar \frac{h}{\hbar}$.
