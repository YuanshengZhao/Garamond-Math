...
\setmainfont{EB Garamond}[Kerning=Off]%
...
\setmathfont{Garamond-Math.otf}[Path=../Release/,StylisticSet={1,2,6}]
...
\end{split}\]
It is known to all that $\sqrt 2$ is irrational $\frac{\partial y}{\partial x}$.
...
\[G\setminus C\smallsetminus F\]
\[ m_ec^2 m_pc^2 g_ec m_fc^2 m_nc^2 m_xc^2 \int_0^1 \big]_0^1\]
