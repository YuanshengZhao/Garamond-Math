...
\setmathfont{Garamond-Math}[StylisticSet={1,2,7,8},Path=./]
\newfontfamily\GaramondMath{Garamond-Math}[StylisticSet={1,2,7},Path=./]
...
$(0) T{ijT_oTT_x^xL_{ff}L_{jj}Uo}iUojj_x^xJj$
