...
\setmathfont{Garamond-Math.otf}[StylisticSet={2,8,9,6,10},Path=./]
\newfontfamily\GaramondMath{Garamond-Math.otf}[StylisticSet={1,7},Path=./]
...
\[V_{x}\]
\[\hbar_{\hbar_\hbar} h_{h_h}\symbf{h_{h_h}}\sqrt[3]{x}\]


$K[x]T[x]\Theta[x]L[x]E[x]H[x]N[x]Z[x]O[x]A[x]P[x]Q[x]\symup H[x]\langle\vert\rangle$
