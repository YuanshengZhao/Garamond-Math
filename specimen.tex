...
\clist_const:Nn \c__xfonttable_unicode_reserved_clist
  {
    ...
    % Miscellaneous Symbols and Arrows
     2B74,  2B75,  2B96,  2B97,  2BBA,  2BBB,  2BBC,  2BC9,  2BD3,  2BD4,
     2BD5,  2BD6,  2BD7,  2BD8,  2BD9,  2BDA,  2BDB,  2BDC,  2BDD,  2BDE,
     2BDF,  2BE0,  2BE1,  2BE2,  2BE3,  2BE4,  2BE5,  2BE6,  2BE7,  2BE8,
     2BE9,  2BEA,  2BEB,  2BF0,  2BF1,  2BF2,  2BF3,  2BF4,  2BF5,  2BF6,
     2BF7,  2BF8,  2BF9,  2BFA,  2BFB,  2BFC,  2BFD,  2BFE,  2BFF,
...
\cs_new_protected:Npn \xfonttable_unicode:nn #1#2
  {
    ...
    \cs_set:Npn \xfonttable_left_foot: { \xfonttable_left_foot_unicode: }
...
\cs_new_protected:Npn \xfonttable_non_unicode:nn #1#2
  {
    ...
    \section{#1 ~ (\tl_use:N \l__xfonttable_glyph_count_tl)}
    \cs_set:Npn \xfonttable_left_foot: { }
...
% #1 = file name (../../data/non-unicode.txt)
...
\cs_new_protected:Npn \xfonttable_left_foot_last_page:
  {
    ...
    EB~ Garamond,~ Courier~ New,~ GNU~ Unifont. \\
...
\newfontface\SymbolFont{Garamond-Math.otf}[StylisticSet=1]
%\newfontface\SymbolFont{FiraSans-Regular.otf}
%\newfontface\SymbolFont{xits-math.otf}
\newfontface\BMPFallbackFont{unifont-10.0.07.ttf}
\newfontface\SMPFallbackFont{unifont_upper-10.0.07.ttf}

\title{Garamond-Math}
\author{Xiangdong Zeng}
\date{2018/01/20 \quad v0.1}
...
%\fonttable*{Non-Unicode Glyphs}{../../data/non-unicode.txt}
