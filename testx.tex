...
\[\left(\sqrt{\cfrac{M}{1-\left(\cfrac{r}{\widetilde{x_1+\cdots+u_N}}\right)^2}\left(\sum_{\beta=1}^{N}\sum_{i=1}^{n}\frac{\partial u_\beta}{\partial x_i}+1\right)}+\sqrt{XY}\right)^3\]
